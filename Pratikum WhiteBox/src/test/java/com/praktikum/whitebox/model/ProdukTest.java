...
public class ProdukTest {
    ...
    @Test
    @DisplayName("Test status aktif")
    void testStatusAktif() {
    ...
    @Test
    @DisplayName("Test status stok - produk tidak aktif")
    void testStokProdukTidakAktif() {
        produk.setStok(10);
        produk.setStokMinimum(5);
        produk.setAktif(false);
    ...
    @Test
    @DisplayName("Test kurangi stok - produk tidak aktif")
    void testKurangiStokProdukTidakAktif() {
        produk.setAktif(false);

        Exception exception = assertThrows(IllegalStateException.class, () -> {
            produk.kurangiStok(5);
        });
        assertEquals("Produk tidak aktif", exception.getMessage());
    }
    ...
    @Test
    @DisplayName("Test tambah stok - produk tidak aktif")
    void testTambahStokProdukTidakAktif() {
        produk.setAktif(false);
    ...
    @Test
    @DisplayName("Test hitung total harga - produk tidak aktif")
    void testHitungTotalHargaProdukTidakAktif() {
        produk.setAktif(false);
